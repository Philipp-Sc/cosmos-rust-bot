...
pub fn requirement_list() -> Vec<(&'static str, i32, Vec<&'static str>)> {
    ...
    vec![
        ...
        /* arbitrage */
        /* anchor_tokens */
        ("simulation terraswap anchorprotocol uluna terraswapblunaLunaPair", fast, vec!["market", "anchor_account", "arbitrage"]),
        ("state anchorprotocol bLunaHub", fast, vec!["market", "anchor_account"]),
        ("simulation_cw20 terraswap anchorprotocol ANC terraswapAncUstPair", fast, vec!["market", "anchor_account", "anchor_auto_farm", "anchor_auto_stake"]),
        ("epoch_state anchorprotocol mmMarket", fast, vec!["anchor", "market", "anchor_account", "anchor_auto_repay"]),
        /* nexus_tokens */
        ("simulation_cw20 terraswap nexusprotocol nLunaToken Psi-nLuna_Pair", fast, vec!["market"]),
        ("simulation_cw20 terraswap nexusprotocol PsiToken Psi-UST_Pair", fast, vec!["market"]),
        /* mirror_tokens */
        ("simulation_cw20 terraswap uusd mir", fast, vec!["market"]),
        ("simulation_cw20 terraswap uusd m_tsla", fast, vec!["market"]),
        ("simulation_cw20 terraswap uusd m_btc", fast, vec!["market"]),
        ("simulation_cw20 terraswap uusd m_eth", fast, vec!["market"]),
        ("simulation_cw20 terraswap uusd m_spy", fast, vec!["market"]),
        /* <other> */
        /* <anchor_protocol> */
