...
pub fn requirement_list() -> Vec<(Vec<&'static str>, i32, Vec<&'static str>)> {
    ...
    vec![
        ...
        /* anchor_tokens */
        (vec!["swap_simulation", "terraswap", "none", "uluna", "Anchor", "bLuna"], fast, vec!["market", "anchor_account", "arbitrage"]),
        (vec!["state", "Anchor", "bLuna Hub"], fast, vec!["market", "anchor_account"]),
        (vec!["swap_simulation", "terraswap", "Anchor", "ANC", "none", "uusd"], fast, vec!["market", "anchor_account", "anchor_auto_farm", "anchor_auto_stake"]),
        (vec!["epoch_state", "Anchor", "Market"], fast, vec!["anchor", "market", "anchor_account", "anchor_auto_repay"]),
        /* nexus_tokens */
        (vec!["swap_simulation", "terraswap", "Nexus", "nLuna", "Nexus", "Psi"], fast, vec!["market"]),
        (vec!["swap_simulation", "terraswap", "Nexus", "Psi", "none", "uusd"], fast, vec!["market"]),
        /* mirror_tokens */
        (vec!["swap_simulation", "terraswap", "Mirror", "MIR", "none", "uusd"], fast, vec!["market"]),
        (vec!["swap_simulation", "terraswap", "Mirror", "mTSLA", "none", "uusd"], fast, vec!["market"]),
        (vec!["swap_simulation", "terraswap", "Mirror", "mBTC", "none", "uusd"], fast, vec!["market"]),
        (vec!["swap_simulation", "terraswap", "Mirror", "mETH", "none", "uusd"], fast, vec!["market"]),
        (vec!["swap_simulation", "terraswap", "Mirror", "mSPY", "none", "uusd"], fast, vec!["market"]),
